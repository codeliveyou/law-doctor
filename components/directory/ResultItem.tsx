...
export default function ResultItem() {
  ...
  return (
    <div className="flex flex-col bg-gray-800 rounded-2xl border hover:border-blue-800 hover:bg-gray-900 border-gray-900 select-none">
      <div className="px-3 sm:px-6 py-3 flex flex-col gap-2">
        <div className="flex justify-between max-xl:flex-col gap-2">
      ...
      <Separator size="4" />
      <div className="flex justify-between px-3 lg:px-6 py-3 flex-wrap">
        ...
        <div className="inline-flex gap-1.5 cursor-pointer" onClick={() => router.push("/directory/readmore")}>
