...
export default function () {
  return (
    <div style={{
      background: "radial-gradient(23.38% 51.43% at 50% 33.03%, rgba(5, 94, 181, 0.30) 0%, rgba(0, 0, 0, 0.00) 100%)"
    }}>
      <div className="py-20 sm:py-32 mx-6 lg:mx-auto lg:max-w-screen-lg">
